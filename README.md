...
コードが書けない非エンジニアが、AIとの対話だけで特許出願レベルのシステムを設計・実装するために実際に使い、検証済みの手法です。CGPは、AIに『判断』させるのではなく『検証』させることで、動いてるけど中身の理屈が分からない"ブラックボックス"化を防ぎます。
...
JP [日本語版はこちら / Japanese](README.ja.md)GB [English version here]()
