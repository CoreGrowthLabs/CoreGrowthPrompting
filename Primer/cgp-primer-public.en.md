...
approach from personal-use CGP Section 3.6 (make the AI break the design,
don't let it critique it) be applied.

- Restrict the instruction to the AI to: **"Show me, by breaking it, that
